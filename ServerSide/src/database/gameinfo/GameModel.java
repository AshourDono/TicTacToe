//#============================================================================#
//#                      interface for game table in database                  #
//#============================================================================#
...
public interface GameModel {
    ...
    static boolean insertRecord(cellType _turn, cellType[] _board, Long _player1, Long _player2) {
        try {
            ...
            System.out.println("Error in game mode insert into database : " + ex.getMessage());
            return false;
        }
    }
//use
    ...
    static boolean updateIdRecord(Long _gid, cellType _turn, cellType[] _board, Long _player1, Long _player2) {
        try {
            ...
            System.out.println("Error in game mode update into database : " + ex.getMessage());
            return false;
        }
    }
    ...
    static boolean updateBoardWhereP1P2(cellType _turn, cellType[] _board, Long _player1, Long _player2) {
        try {
            ...
            System.out.println("Error in game mode update Board : " + ex.getMessage());
            return false;
        }
    }
...
//use
    ...
    static boolean deleteIdRecord(long _gid) {
        try {
            ...
            System.out.println("Error in game mode deleteIdRecord : " + ex.getMessage());
            return false;
        }
    }
    ...
    static boolean deleteP1Record(long _player1) {
        try {
            ...
            System.out.println("Error in game mode delete p1 : " + ex.getMessage());
            return false;
        }
    }
    ...
    static boolean deleteP2Record(long _player2) {
        try {
            ...
            System.out.println("Error in game mode delete p2 : " + ex.getMessage());
            return false;
        }
    }
    ...
    static boolean deleteP1P2Record(long _player1, long _player2) {
        try {
            ...
            System.out.println("Error in game mode deleteP1P2Record : " + ex.getMessage());
            return false;
        }
    }
...
//use
    static Game selectGameWhereId(Long _gid) {
        try {
            ...
            System.out.println("Error in game mode selectGameWhereId : " + ex.getMessage());
            return null;
        }
    }
    ...
    static Game selectGameWhereP1P2Date(Long _player1, Long _player2, String _created_at) {
        try {
            ...
            System.out.println("Error in game mode selectGameWhereP1P2Date : " + ex.getMessage());
            return null;
        }
    }
    ...
    static Vector<Game> selectAllWhereP1P2(Long _player1, Long _player2) {
        try {
            ...
            System.out.println("Error in game mode selectAllWhereP1P2 : " + ex.getMessage());
            return null;
        }
    }
    // check 
    static Vector<Game> selectAllGames() {
        try {
            ...
            System.out.println("Error in game mode selectAllGames : " + ex.getMessage());
            return null;
        }
    }
    ...
    static Vector<Game> selectAllGamesOrderByDESC(String colName) {
        try {
            ...
            System.out.println("Error in game mode selectAllGamesOrderByDESC: " + ex.getMessage());
            return null;
        }
    }
    ...
    static Vector<Game> selectAllGamesOrderByASC(String colName) {
        try {
            ...
            System.out.println("Error in game mode selectAllGamesOrderByASC : " + ex.getMessage());
            return null;
        }
    }
    ...
    static Vector<Game> selectAllWhereP1(String _player1UserName) {
        try {
            ...
            System.out.println("Error in game mode selectAllWhereP1 : " + ex.getMessage());
            return null;
        }
    }
    ...
    static Vector<Game> selectAllWhereP1OrderedDesc(String _player1UserName, String _colOrder) {
        try {
            ...
            System.out.println("Error in game mode selectAllWhereP1OrderedDesc : " + ex.getMessage());
            return null;
        }
    }
//use
    static Vector<Game> selectAllWhereP1OrderedDescDate(String _player1UserName) {
        try {
            ...
            System.out.println("Error in game mode selectAllWhereP1OrderedDescDate : " + ex.getMessage());
            return null;
        }
    }
}
