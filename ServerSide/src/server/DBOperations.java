//#============================================================================#
//#         abstract that is responsbile for interacing with database          #
//#============================================================================#
package server;
...
public abstract class DBOperations {
    ...
    public static Player register(String username, String password){
        ...
        boolean isCreated = DBMethods.addPlayer(newPlayer.getUsername() ,newPlayer.getPasswd(), newPlayer.getStatus().toString(), newPlayer.getScore());
