...
public class GameHandler extends Thread {
    ...
    private void broadcast(JSONObject json) {
        ...
        try {
            ...
            //and end the game
            System.out.println("Error in game hundler broadcast p1 : " + ex.getMessage());
        ...
        try {
            ...
            System.out.println("Error game hundler broadcast p2 : " + ex.getMessage());
            //the player has dropped connection (consider him as a player quit
            //and end the game
    ...
    private boolean sendResponseToPlayer(JSONObject response, DataOutputStream output) {
        try {
            ...
            System.out.println("Error game hundler sendResponseToPlayer: " + ex.getMessage());
            return false;
        }
    }
