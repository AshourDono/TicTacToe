...
public class AuthenHandler extends Thread {
    ...
    public AuthenHandler(Socket socket) {
        ...
        try {
            ...
            System.out.println("Error in hundler AuthenHandler : " + ex.getMessage());
    ...
    public void run() {
        while (isStayAlive) {
            try {
                ...
                System.out.println("Error in hundler run : " + ex.getMessage());
    ...
    public void close() {
        ...
        try {
            ...
            System.out.println("Error in hundler close : " + ex.getMessage());
