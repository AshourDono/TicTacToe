...
public class PlayerHandler extends Thread {
        ...
        public void run() {
            try {
                ...
                while (!isReceived) {
                    ...
                    if (receiverJson == null); else if (receiverJson.get("type").equals(Requests.RECEIVE_INVITATION)) {
                        isReceived = true;
                    }
                }
                ...
                System.out.println("Error player handler run ex : " + ex.getMessage());
                //Conection Failed
    ...
    public PlayerHandler(Socket socket, Player playerInfo) {
        ...
        try {
            ...
            System.out.println("Error PlayerHandler : " + ex.getMessage());
    ...
    public void run() {
        ...
        while (isStayAlive) {
            try {
                ...
                System.out.println("Error PlayerHandler run 2 : " + ex.getMessage());
    ...
    public void close() {
        try {
            ...
            System.out.println("Error PlayerHandler getOnlinePlayerHandlers : " + ex.getMessage());
